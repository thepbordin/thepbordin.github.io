...
const DecayCard: React.FC<DecayCardProps> = ({
  ...
  useEffect(() => {
    // Set initial values based on window size inside useEffect
    cursor.current = {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-[1.2em] left-[1em] text-[2.5rem] font-black leading-[1.5em] tracking-[-0.5px] first-line:text-[6rem]">
        {children}
      </div>
    </div>
  );
